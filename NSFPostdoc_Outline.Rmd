...
## Timetable: Year 1 (South Australian Museum---Australia)
```{r echo = FALSE}
library(knitr); library(pander)

df <- data.frame(Research = "Collect morphological data. Build reptile database, and 
                              integrate it into ALA[^1]",
                 Training = "a",
                 Dissemination = "Release extended specimen data format for ALA. Present database to colleagues in ecology and evolution")

pander(df, split.cell=20, split.table=Inf)
```

## Timetable: Year 2 (University of Tennesee---USA)
```{r echo = FALSE}
library(knitr); library(pander)

df <- data.frame(Research = "Build ABC^1^ framework for PCMs^1^",
                 Training = "a",
                 Dissemination = "Release extended specimen data format for ALA. Present database to colleagues in ecology and evolution")
...
## Timetable: Year 3 (University of Tennesee---USA)
```{r echo = FALSE}
library(knitr); library(pander)

df <- data.frame(Research = "Package and release ABC framework for lineage interactions",
                 Training = "a",
                 Dissemination = "Release extended specimen data format for ALA. Present database to colleagues in ecology and evolution")
